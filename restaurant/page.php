...
<body data-aos-easing="ease-out-back" data-aos-duration="1500" data-aos-delay="0">
    ...
    <nav class="navbar navbar-expand-md navbar-dark position-sticky-top fixed-top">
        <div class="canvas-area">
            <div class="head1">
                <a class="navbar-logo" href="#"><img src="logo.png"
            ...
            <div class="collapse navbar-collapse text-right" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="page-menu.php">menu</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container" style="height:600px" id="about">
        <div class="second">
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <img src="o_nama3.jpg" style="height:25%;padding-left:100px;width=50%">
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <div class="d-flex flex-row" id="mc_embed_signup">
                                <form class="navbar-form"
                                    action="https://spondonit.us12.list-manage.com/subscribe/post?u=1462626880ade1ac87bd9c93a&amp;id=9
                                    method="get" novalidate="true">
                                    <div class="input-group add-on align-items-center d-flex">
                                        <input class="form-control" name="EMAIL" placeholder="Your Email address"
                                            onfocus="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = ''"
                                            onblur="if (!window.__cfRLUnblockHandlers) return false; this.placeholder = 'Your Email ad
                                            required="" type="email">
